...
namespace Cinteros.Xrm.FetchXmlBuilder
{
    [Export(typeof(IXrmToolBoxPlugin)),
        ...
        ExportMetadata("Description", "Build queries for Microsoft Common Data Service, CRM, XRM and the Power Platform. Investigate data. Get code. Empower yourself to achieve more."),
